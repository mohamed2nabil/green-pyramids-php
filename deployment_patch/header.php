...
<html lang="en">
  <head>
    ...
    <meta property="og:image" content="<?= $protocol ?>://<?= $domain ?><?= htmlspecialchars(asset_url('assets/images/static/hero_background.png')) ?>">
    ...
    <meta name="twitter:image" content="<?= $protocol ?>://<?= $domain ?><?= htmlspecialchars(asset_url('assets/images/static/hero_background.png')) ?>">
    ...
    <link rel="stylesheet" href="<?= htmlspecialchars(asset_url('assets/css/tailwind.css')) ?>?v=<?= $assetVersion('assets/css/tailwind.css') ?>">
    <link rel="stylesheet" href="<?= htmlspecialchars(asset_url('assets/css/main.css')) ?>?v=<?= $assetVersion('assets/css/main.css') ?>">
    <link rel="stylesheet" href="<?= htmlspecialchars(asset_url('assets/css/animations.css')) ?>?v=<?= $assetVersion('assets/css/animations.css') ?>">
    <link rel="icon" type="image/svg+xml" href="<?= htmlspecialchars(asset_url('assets/favicon.svg')) ?>">
